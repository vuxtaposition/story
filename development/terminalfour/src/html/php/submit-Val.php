...
<head>
  ...
  <meta content="Story of your stuff" name="description">
  <meta content="Environmental Protection Agency (EPA)" name="DC.Author">
  <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
  <title> Submit - Story of your stuff - EPA</title>
  <link href="style-assets/css/style-local.css" rel="stylesheet">
  <link href="style-assets/css/framework.css" rel="stylesheet">
...
<body>
  <div class="container">
    <nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="index.html"> <img src="style-assets/images/al/footer-logo.png" alt="header logo" class="logoHover"/></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse mobileMenu">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/teachers.html">FOR TEACHERS</a>
            </li>
            <li class="nav-item">
    ...
    <div class="row marketing bg-1">
      <div class="col-lg-8 col-md-offset-2 dashed">
        <h2>READY TO SUBMIT? LET’S DO THIS!</h2>
         <div class="imageContainer">
         <img id="replaceSteps" src="style-assets/images/replace-steps.png" alt="step one step two and step three" />
            <div class="col-lg-4 imageContainers" >
              <img alt="first prize" src="style-assets/images/home/step1big.png" > 
            </div>
            <div class="col-lg-4 imageContainer2" >
              <img alt="second prize" src="style-assets/images/home/step2big.png" > 
            </div>
            <div class="col-lg-4 imageContainer3" >        
              <img alt="third prize" src="style-assets/images/home/step3big.png" >
            </div>
          </div>
  ...
  <?php endif; ?>
  <form action="submit.php" id="submitForm" method="post" name="submitForm" enctype="multipart/form-data">
    <div class="row marketing bg-form">
      <div class="col-lg-8 col-md-offset-2 dashed">
        <div class="col-lg-3"><img alt="first prize" class="formIcon" src="style-assets/images/home/step1big.png"></div><span class="pull-right topNotice"><span class="reqred">* &nbsp;</span>&nbsp;Required fields</span>
        <div class="col-lg-9">
          <div class="form-group">
          ...
          <div class="form-group">
            <span class="reqred">*</span>&nbsp; <label for="teachersname">Teachers name:</label> <input class="form-control" id="teachersname" name="teachersname" placeholder="Enter Teachers name" type="text" value="<?php echo isset($Leadname) ? $Leadname->getValue() : null; ?>">
          </div>
          <div class="form-group">
            <span class="reqred">*</span>&nbsp; <label for="schoolname">School name:</label> <input class="form-control" id="schoolname" name="schoolname" placeholder="Enter schools name" type="text" value="<?php echo isset($Leadname) ? $Leadname->getValue() : null; ?>">
          </div>
          <div class="form-group">
            <span class="reqred">*</span>&nbsp; <label for="county">County:</label> <input class="form-control" id="county" name="county" placeholder="Enter your county" type="text" value="<?php echo isset($Leadname) ? $Leadname->getValue() : null; ?>">
          </div>
          <div class="form-group">
            <span class="reqred">*</span>&nbsp; <label for="email">E-mail Address:</label> <input class="form-control" id="email" name="email" placeholder="Enter your email" type="email" value="<?php echo isset($Leadname) ? $Leadname->getValue() : null; ?>">
          </div>
        </div>
   ...
   <footer class="footer-epa">
      <a href="index.html"><img alt="footer logo" class="logoHover" src="style-assets/images/al/footer-logo.png"></a> 
      <span class="pull-right marginRight">
	  <a href="https://www.epa.ie"><img class="fb-icon" alt="footer social epa logo" src="style-assets/images/epaSocial.png"></a>
      <a href="https://www.facebook.com/EPALiveGreen/"><img class="fb-icon" alt="footer social facebook logo" src="style-assets/images/facebook.png"></a>
	  <a href="https://twitter.com/EPAireland"><img class="fb-icon" alt="footer social epa logo" src="style-assets/images/twitter.png"></a>
      <a href="https://www.youtube.com/user/epaireland"><img class="fb-icon" alt="footer social youTube logo" src="style-assets/images/youtube.png"></a>
      </span>
    </footer>
  </div><!-- /container -->
  <script src="style-assets/js/bootstrap.js">
  </script> 
  <script src="style-assets/js/t4-custom.min.js">
  </script>
